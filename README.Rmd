...
tab[Name == "selected_features", `Package` := ""]
tab[Name == "importance", `Package` := ""]
...
To select features based on filter values, one can use [`PipeOpFilter`](https://mlr3pipelines.mlr-org.com/reference/mlr_pipeops_filter.html) from
[mlr3pipelines](https://github.com/mlr-org/mlr3pipelines) to e.g. select features before
training a learner.
