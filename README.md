...
| Name              | label                                                    | Task Types     | Feature Types                                                  | Package                                                                                                           | Task Type |
|:------------------|:---------------------------------------------------------|:---------------|:---------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------|:----------|
| anova             | ANOVA F-Test                                             | Classif        | Integer, Numeric                                               | stats                                                                                                             | NA        |
| auc               | Area Under the ROC Curve Score                           | Classif        | Integer, Numeric                                               | [mlr3measures](https://cran.r-project.org/package=mlr3measures)                                                   | NA        |
| carscore          | Correlation-Adjusted coRrelation Score                   | Regr           | Numeric                                                        | [care](https://cran.r-project.org/package=care)                                                                   | NA        |
...
| find_correlation  | Correlation-based Score                                  | Classif & Regr | Integer, Numeric                                               | stats                                                                                                             | NA        |
| importance        | Importance Score                                         | Classif        | Logical, Integer, Numeric, Character, Factor, Ordered, POSIXct |                                                                                                                   | Universal |
| information_gain  | Information Gain                                         | Classif & Regr | Integer, Numeric, Factor, Ordered                              | [FSelectorRcpp](https://cran.r-project.org/package=FSelectorRcpp)                                                 | NA        |
| jmi               | Joint Mutual Information                                 | Classif & Regr | Integer, Numeric, Factor, Ordered                              | [praznik](https://cran.r-project.org/package=praznik)                                                             | NA        |
| jmim              | Minimal Joint Mutual Information Maximization            | Classif & Regr | Integer, Numeric, Factor, Ordered                              | [praznik](https://cran.r-project.org/package=praznik)                                                             | NA        |
| kruskal_test      | Kruskal-Wallis Test                                      | Classif        | Integer, Numeric                                               | stats                                                                                                             | NA        |
| mim               | Mutual Information Maximization                          | Classif & Regr | Integer, Numeric, Factor, Ordered                              | [praznik](https://cran.r-project.org/package=praznik)                                                             | NA        |
| mrmr              | Minimum Redundancy Maximal Relevancy                     | Classif & Regr | Integer, Numeric, Factor, Ordered                              | [praznik](https://cran.r-project.org/package=praznik)                                                             | NA        |
| njmim             | Minimal Normalised Joint Mutual Information Maximization | Classif & Regr | Integer, Numeric, Factor, Ordered                              | [praznik](https://cran.r-project.org/package=praznik)                                                             | NA        |
| performance       | Predictive Performance                                   | Classif        | Logical, Integer, Numeric, Character, Factor, Ordered, POSIXct |                                                                                                                   | Universal |
| permutation       | Permutation Score                                        | Classif        | Logical, Integer, Numeric, Character, Factor, Ordered, POSIXct |                                                                                                                   | Universal |
| relief            | RELIEF                                                   | Classif & Regr | Integer, Numeric, Factor, Ordered                              | [FSelectorRcpp](https://cran.r-project.org/package=FSelectorRcpp)                                                 | NA        |
| selected_features | Embedded Feature Selection                               | Classif        | Logical, Integer, Numeric, Character, Factor, Ordered, POSIXct |                                                                                                                   | NA        |
| variance          | Variance                                                 | NA             | Integer, Numeric                                               | stats                                                                                                             | NA        |
