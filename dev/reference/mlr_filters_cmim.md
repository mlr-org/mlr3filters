...
Minimal conditional mutual information maximization filter calling
[`praznik::CMIM()`](https://rdrr.io/pkg/praznik/man/CMIM.html) from
...
- [`FilterCMIM$new()`](#method-FilterCMIM-initialize)

- [`FilterCMIM$clone()`](#method-FilterCMIM-clone)
