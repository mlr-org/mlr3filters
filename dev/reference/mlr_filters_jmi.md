...
Joint mutual information filter calling
[`praznik::JMI()`](https://rdrr.io/pkg/praznik/man/JMI.html) in package
...
- [`FilterJMI$new()`](#method-FilterJMI-initialize)

- [`FilterJMI$clone()`](#method-FilterJMI-clone)
